...
public interface EnemyController {
     ...
     * @param rinoModel the model interface of the rino A {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel}
     */
    void collide(RinoModel rinoModel);
    /**
     * Method that check if the rinoModel is in the rinos map.
     * @param rinoModel A {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel} the model interface of the rino
     * @return the method isSetToDestroy of the RinoModel
     */
    boolean isSetToDestroy(RinoModel rinoModel);
    /**
     * Method that check if the rinoModel is in the rinos map and call the method reverseVelocity in the RinoModel.
     * @param rinoModel A {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel} the model interface of the rino
     */
    void reverseVelocity(RinoModel rinoModel);
    /**
     * Method that check if the rinoModel is in the rinos map.
     * @param rinoModel {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel} the model interface of the rino
    ...
    /**
     *  Method that check if the rinoModel is in the rinos map and call the method setDeathRegion of the RinoModel.
     * @param rinoModel {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel} the model of the enemy rino
     */

    void setDeathRegion(RinoModel rinoModel);
    /**
     *  Method that check if the rinoModel is in the rinos map and call the method update in the view part of the enemi rino.
     * @param rinoModel {@link it.unibo.ninjafrog.enemies.RinoModel RinoModel} the model of the enemy rino
    ...
    /**
     * Method that check if the rinoView is in the rinos map and set the boolean runningLeft of the rinoModelImpl.
     * @param rinoView {@link it.unibo.ninjafrog.enemies.RinoView RinoView} the view of the enemy rino
    ...
    /**
     * Method that check if the turtleModel is in the turtles map and return X position of the turtle.
    ...
    /**
     * Method that check if the turtleModel is in the turtles map and return Y position of the turtle.
     * @param turtleModel {@link it.unibo.ninjafrog.enemies.TurtleModel TurtleModel} the model part of the enemy turtle
    ...
    /**
     * Method that check if the turtleModel is in the turtles map and call the method setDeathRegion in the TurtleView.
     * @param turtleModel {@link it.unibo.ninjafrog.enemies.TurtleModel TurtleModel} the model part of the enemy turtle
     */
